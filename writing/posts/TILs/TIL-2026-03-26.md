...
- Technical
	- [[#Running multiple programs in parallel in bash|Running multiple programs in parallel in bash]]
		- [[#Running multiple programs in parallel in bash#Worker pools|Worker pools]]
